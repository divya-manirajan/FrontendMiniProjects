...
import ApodItem from "@/app/components/ApodItem";
...
export default function page() {
  ...
  const fetchData = async () => {
    ...
    const APOD_API = `https://api.nasa.gov/planetary/apod?start_date=${startDate}&end_date=${endDate}&api_key=${process.env.NEXT_PUBLIC_NASA_API_KEY}`
